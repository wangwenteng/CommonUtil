...
public class StringUtils {
     ...
     * @return
     */
    public static String nameMaskForLastName(String name) {
        String result;
        if (name.length() <= 1) {
            result = "*";
        } else {
            ...
            if (name.contains("•") || name.contains("·")) {
                if (name.contains("·")) {
                    replaceLength = name.length() - name.indexOf("·");
                }
                if (name.contains("•")) {
                    replaceLength = name.length() - name.indexOf("•");
                }
                result = name.replaceAll("([\\u4e00-\\u9fa5]+[·•])(.*)", createAsterisk(replaceLength) + "$2");
            } else {
                replaceLength = name.length() - 1;
                result = name.replaceAll("([\\u4e00-\\u9fa5]{1})([\\u4e00-\\u9fa5]+)", "$1" + createAsterisk(replaceLength));
            }
        }
        return result;
    }
     ...
     * @return
     */
    public static String nameDisplayFirstStr(String name) {
        int replaceLength = name.length()-1;
        String result = name.replaceAll("([\\u4e00-\\u9fa5]{1})([\\u4e00-\\u9fa5]+)", "$1" + createAsterisk(replaceLength));
        return result;
    }

    public static void main(String[] args) {
        System.out.println(idMask("362201198408243688", 6, 0));
        System.out.println(nameMask("张三三"));
        System.out.println(nameMask("买买提•阿不来提"));
        System.out.println(nameMaskForLastName("张三三"));
        System.out.println(nameMaskForLastName("买买提•阿不来提"));
        System.out.println(nameDisplayFirstStr("张三三"));
        System.out.println(nameDisplayFirstStr("买买提•阿不来提"));
    }
